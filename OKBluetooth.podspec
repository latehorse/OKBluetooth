...
Pod::Spec.new do |s|
  s.name             = 'OKBluetooth'
  s.version          = '0.1.0'
  s.summary          = 'A short description of OKBluetooth.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/deadvia/OKBluetooth'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'deadvia' => 'deadvia@gmail.com' }
  s.source           = { :git => 'https://github.com/deadvia/OKBluetooth.git', :tag => s.version.to_s }
